...
/*
TriggersApiService All triggers for current user
...
@return []Trigger
*/
func (a *TriggersApiService) AllTriggers(ctx context.Context, username string) ([]Trigger, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/{username}/triggers"
...
/*
TriggersApiService Create a new Trigger
...
@return Trigger
*/
func (a *TriggersApiService) CreateTrigger(ctx context.Context, username string, trigger Trigger) (Trigger, *http.Response, error) {
	var (
...
/*
TriggersApiService Delete an existing Trigger
...
@return string
*/
func (a *TriggersApiService) DestroyTrigger(ctx context.Context, username string, id string) (string, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/{username}/triggers/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"username"+"}", fmt.Sprintf("%v", username), -1)
...
/*
TriggersApiService Returns Trigger based on ID
...
@return Trigger
*/
func (a *TriggersApiService) GetTrigger(ctx context.Context, username string, id string) (Trigger, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
TriggersApiService Replace an existing Trigger
...
@return Trigger
*/
func (a *TriggersApiService) ReplaceTrigger(ctx context.Context, username string, id string, trigger Trigger) (Trigger, *http.Response, error) {
	var (
...
/*
TriggersApiService Update properties of an existing Trigger
...
@return Trigger
*/
func (a *TriggersApiService) UpdateTrigger(ctx context.Context, username string, id string, trigger Trigger) (Trigger, *http.Response, error) {
	var (
