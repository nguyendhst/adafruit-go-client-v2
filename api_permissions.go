...
/*
PermissionsApiService All permissions for current user and type
...
@return []Permission
*/
func (a *PermissionsApiService) AllPermissions(ctx context.Context, username string, type_ string, typeId string) ([]Permission, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/{username}/{type}/{type_id}/acl"
...
/*
PermissionsApiService Create a new Permission
...
@return Permission
*/
func (a *PermissionsApiService) CreatePermission(ctx context.Context, username string, type_ string, typeId string, permission Permission) (Permission, *http.Response, error) {
	var (
...
/*
PermissionsApiService Delete an existing Permission
...
@return string
*/
func (a *PermissionsApiService) DestroyPermission(ctx context.Context, username string, type_ string, typeId string, id string) (string, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/{username}/{type}/{type_id}/acl/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"username"+"}", fmt.Sprintf("%v", username), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"type"+"}", fmt.Sprintf("%v", type_), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"type_id"+"}", fmt.Sprintf("%v", typeId), -1)
...
/*
PermissionsApiService Returns Permission based on ID
...
@return Permission
*/
func (a *PermissionsApiService) GetPermission(ctx context.Context, username string, type_ string, typeId string, id string) (Permission, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
PermissionsApiService Replace an existing Permission
...
@return Permission
*/
func (a *PermissionsApiService) ReplacePermission(ctx context.Context, username string, type_ string, typeId string, id string, permission Permission) (Permission, *http.Response, error) {
	var (
...
/*
PermissionsApiService Update properties of an existing Permission
...
@return Permission
*/
func (a *PermissionsApiService) UpdatePermission(ctx context.Context, username string, type_ string, typeId string, id string, permission Permission) (Permission, *http.Response, error) {
	var (
