...
/*
WebhooksApiService Send arbitrary data to a feed via webhook URL.
...
@return Data
*/
func (a *WebhooksApiService) CreateRawWebhookFeedData(ctx context.Context) (Data, *http.Response, error) {
	var (
...
/*
WebhooksApiService Send data to a feed via webhook URL.
...
@return Data
*/
func (a *WebhooksApiService) CreateWebhookFeedData(ctx context.Context, payload Payload) (Data, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
