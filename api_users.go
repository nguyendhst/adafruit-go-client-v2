...
/*
UsersApiService Get information about the current user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().

@return User
*/
func (a *UsersApiService) CurrentUser(ctx context.Context) (User, *http.Response, error) {
	var (
...
/*
UsersApiService Get the user&#39;s data rate limit and current activity level.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param username a valid username string

@return InlineResponse200
*/
func (a *UsersApiService) GetCurrentUserThrottle(ctx context.Context, username string) (InlineResponse200, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/{username}/throttle"
