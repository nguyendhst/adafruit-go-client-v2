...
/*
DashboardsApiService All dashboards for current user
...
@return []Dashboard
*/
func (a *DashboardsApiService) AllDashboards(ctx context.Context, username string) ([]Dashboard, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/{username}/dashboards"
...
/*
DashboardsApiService Create a new Dashboard
...
@return Dashboard
*/
func (a *DashboardsApiService) CreateDashboard(ctx context.Context, username string, dashboard Dashboard) (Dashboard, *http.Response, error) {
	var (
...
/*
DashboardsApiService Delete an existing Dashboard
...
@return string
*/
func (a *DashboardsApiService) DestroyDashboard(ctx context.Context, username string, id string) (string, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/{username}/dashboards/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"username"+"}", fmt.Sprintf("%v", username), -1)
...
/*
DashboardsApiService Returns Dashboard based on ID
...
@return Dashboard
*/
func (a *DashboardsApiService) GetDashboard(ctx context.Context, username string, id string) (Dashboard, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
DashboardsApiService Replace an existing Dashboard
...
@return Dashboard
*/
func (a *DashboardsApiService) ReplaceDashboard(ctx context.Context, username string, id string, dashboard Dashboard) (Dashboard, *http.Response, error) {
	var (
...
/*
DashboardsApiService Update properties of an existing Dashboard
...
@return Dashboard
*/
func (a *DashboardsApiService) UpdateDashboard(ctx context.Context, username string, id string, dashboard Dashboard) (Dashboard, *http.Response, error) {
	var (
