...
/*
TokensApiService All tokens for current user
...
@return []Token
*/
func (a *TokensApiService) AllTokens(ctx context.Context, username string) ([]Token, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/{username}/tokens"
...
/*
TokensApiService Create a new Token
...
@return Token
*/
func (a *TokensApiService) CreateToken(ctx context.Context, username string, token Token) (Token, *http.Response, error) {
	var (
...
/*
TokensApiService Delete an existing Token
...
@return string
*/
func (a *TokensApiService) DestroyToken(ctx context.Context, username string, id string) (string, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/{username}/tokens/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"username"+"}", fmt.Sprintf("%v", username), -1)
...
/*
TokensApiService Returns Token based on ID
...
@return Token
*/
func (a *TokensApiService) GetToken(ctx context.Context, username string, id string) (Token, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
TokensApiService Replace an existing Token
...
@return Token
*/
func (a *TokensApiService) ReplaceToken(ctx context.Context, username string, id string, token Token) (Token, *http.Response, error) {
	var (
...
/*
TokensApiService Update properties of an existing Token
...
@return Token
*/
func (a *TokensApiService) UpdateToken(ctx context.Context, username string, id string, token Token) (Token, *http.Response, error) {
	var (
